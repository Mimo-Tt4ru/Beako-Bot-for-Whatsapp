...
describe('groupFeatureStore', () => {
  ...
  it('persiste estado em mysql, redis e arquivo fallback', async () => {
    ...
    expect(mockRedisClient.hSet).toHaveBeenCalledWith('beako:conexao:default:features:group', 'grupo@g.us', expect.stringContaining('"antilink":true'))
