...
const executeStickerConvert =
  ...
  async (ctx) => {
    ...
    try {
      ...
      await ctx.reply(`❌ Infelizmente não foi possível converter a figurinha: ${message}`)
    }
  }
